...
# ================== الإعدادات ==================
TOKEN = "7566025573:AAFfAiy6J65J7xqkMf3OiFeFD3ELj7q0Wmo"
ADMIN_ID = 7644436020
CHANNEL = "@Silk7Road"
...
async def start_deal(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text(
        f"🔐 صفقه خاصه يتم التحويل الى محفظه الأدره ويحجز المبلغ حتى التأكد ان البائع قام بالتسليم اصولا حسب الشروط المتفق عليها وفي حال مخالفه البائع للشروط يتم ايقاف الصفقه وارجاع المبلغ كاملا مع المحافظه على سريه معلومات الطرفين اذا كنت متأكد من الشرا اضغط على (موافق) ليتم التواصل معك بشكل رسمي  ...\n\n{o['details']}\n💵 {o['price']}",
        reply_markup=InlineKeyboardMarkup(kb)
    )
